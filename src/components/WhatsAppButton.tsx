    ...
    <div className="fixed bottom-6 right-6 z-50">
      <div className="relative group">
        ...
        >
          ...
          {/* إشعار متاح الآن */}
          <div className="absolute -top-2 -right-2 bg-green-400 text-black text-xs rounded-full px-2 py-1 animate-pulse font-bold shadow-lg border-2 border-white">
            متاح الآن
          </div>
        </button>
        
        {/* معلومات الموظف عند التمرير */}
        <div className="absolute bottom-16 right-0 bg-gray-900 text-white p-3 rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
